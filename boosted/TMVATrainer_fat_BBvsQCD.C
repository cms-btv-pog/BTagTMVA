...
void TMVATrainer(){
   ...
   TString outfileName = "TMVATrainingResults_fat_BBvsQCD.root";
   ...
   // Gradient Boost
   factory->BookMethod( TMVA::Types::kBDT, "BDTG_T1000D3_fat_BBvsQCD",
   ...
   //factory->BookMethod( TMVA::Types::kBDT, "BDTG_T1000D5_fat_BBvsQCD",
