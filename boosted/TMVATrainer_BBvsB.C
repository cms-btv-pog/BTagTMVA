...
void TMVATrainer(){
   ...
   TString outfileName = "TMVATrainingResults_BBvsB.root";
   ...
   // Gradient Boost
   factory->BookMethod( TMVA::Types::kBDT, "BDTG_T1000D3_BBvsB",
   ...
   //factory->BookMethod( TMVA::Types::kBDT, "BDTG_T1000D5_BBvsB",
