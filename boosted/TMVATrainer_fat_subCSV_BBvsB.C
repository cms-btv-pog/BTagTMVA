...
void TMVATrainer(){
   ...
   TString outfileName = "TMVATrainingResults_fat_subCSV_BBvsB.root";
   ...
   factory->AddVariable("SubJet1_CSVIVF","SubJet1_CSVIVF","units",'F');
   factory->AddVariable("SubJet2_CSVIVF","SubJet2_CSVIVF","units",'F');
   ...
   TCut backgroundCut = "abs(Jet_flavour)==5 && Jet_nbHadrons<2 && Jet_massGroomed>80 && Jet_massGroomed<150";

   // Tell the factory how to use the training and testing events
   factory->PrepareTrainingAndTestTree( signalCut, backgroundCut,
                                        "nTrain_Signal=15000:nTest_Signal=20000:nTrain_Background=15000:nTest_Background=508:SplitMode=Random:!V" );

   // Gradient Boost
   factory->BookMethod( TMVA::Types::kBDT, "BDTG_T1000D3_fat_subCSV_BBvsB",
   ...
   //factory->BookMethod( TMVA::Types::kBDT, "BDTG_T1000D5_fat_subCSV_BBvsB",
