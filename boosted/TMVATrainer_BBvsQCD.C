...
void TMVATrainer(){
   ...
   TString outfileName = "TMVATrainingResults_BBvsQCD.root";
   ...
   // Gradient Boost
   factory->BookMethod( TMVA::Types::kBDT, "BDTG_T1000D3_BBvsQCD",
   ...
   //factory->BookMethod( TMVA::Types::kBDT, "BDTG_T1000D5_BBvsQCD",
