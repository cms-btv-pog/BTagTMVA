...
void TMVATrainer(){
   ...
   TString outfileName = "TMVATrainingResults_fat_BBvsB.root";
   ...
   // Gradient Boost
   factory->BookMethod( TMVA::Types::kBDT, "BDTG_T1000D3_fat_BBvsB",
   ...
   //factory->BookMethod( TMVA::Types::kBDT, "BDTG_T1000D5_fat_BBvsB",
