...
void TMVAReader(){
    ...
    reader->BookMVA( "BDTG_T1000D3_BBvsGSP method", "weights/TMVATrainer_BDTG_T1000D3_BBvsGSP.weights.xml" );
    ...
    for(Long64_t iEntry = 0; iEntry < intree->GetEntries(); iEntry++){
	    ...
	    float BDTG_Disc = reader->EvaluateMVA("BDTG_T1000D3_BBvsGSP method");
    ...
    TString outname = "BDTG_vs_CSVv2IVF_BBvsGSP.root";
