...
void TMVATrainer(){
   ...
   TString outfileName = "TMVATrainingResults_AllVtx_BvsC.root";
   ...
   // Gradient Boost
   factory->BookMethod( TMVA::Types::kBDT, "BDTG_T1000D3_BvsC",
   ...
   //factory->BookMethod( TMVA::Types::kBDT, "BDTG_T1000D5_BvsC",
