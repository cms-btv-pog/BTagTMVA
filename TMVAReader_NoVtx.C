...
void TMVAReader(){
    ...
    float TagVarCSV_trackEtaRel_ThirdLowest;              // third lowest track eta relative to jet axis
        ...
        reader->AddSpectator("TagVarCSV_trackEtaRel_Lowest",&TagVarCSV_trackEtaRel_Lowest);
        reader->AddSpectator("TagVarCSV_trackEtaRel_SecondLowest",&TagVarCSV_trackEtaRel_SecondLowest);
        reader->AddSpectator("TagVarCSV_trackEtaRel_ThirdLowest",&TagVarCSV_trackEtaRel_ThirdLowest);
...
//         }
        reader->BookMVA( "BDTG method", "weights/TMVATrainer_VtxCat2_BDTG.weights.xml" );
...
//                         hBDTGT1000D5DiscBkg->Fill(BDTG_T1000_D5_Disc);
        ...
        TString outname = "QCD_Pt-120to170_TuneZ2star_8TeV_pythia6_BDTG_vs_CSV_VtxCat2_VtxCat2Training.root";
