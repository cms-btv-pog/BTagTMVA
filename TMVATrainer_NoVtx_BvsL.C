...
void TMVATrainer(){
   ...
   TString outfileName = "TMVATrainingResults_NoVtx_BvsL.root";
   ...
   TMVA::Factory *factory = new TMVA::Factory( "TMVATrainer_NoVtx", outputFile,
   ...
   factory->AddSpectator("TagVarCSV_trackEtaRel_0","TagVarCSV_trackEtaRel_0","units",'F');
   factory->AddSpectator("TagVarCSV_trackEtaRel_1","TagVarCSV_trackEtaRel_1","units",'F');
   factory->AddSpectator("TagVarCSV_trackEtaRel_2","TagVarCSV_trackEtaRel_2","units",'F');
   ...
   TCut signalCut = "abs(Jet_flavour)==5 && TagVarCSV_vertexCategory==2";
   TCut backgroundCut = "abs(Jet_flavour)!=5 && abs(Jet_flavour)!=4 && TagVarCSV_vertexCategory==2";

   // Tell the factory how to use the training and testing events
   factory->PrepareTrainingAndTestTree( signalCut, backgroundCut,
                                        "nTrain_Signal=17000:nTest_Signal=6224:nTrain_Background=17000:nTest_Background=60000:SplitMode=Random:!V" );
