...
void TMVATrainer(){
   ...
   TString outfileName = "TMVATrainingResults_AllVtxV2.root";
   ...
   TCut backgroundCut = "abs(Jet_flavour)!=5 && abs(Jet_flavour)!=4";
...
//    nBkgEvents.push_back(2186422); //for 2
   ...
   factory->PrepareTrainingAndTestTree( signalCut, backgroundCut,
                                        "nTrain_Background=77000:nTest_Background=80000:SplitMode=Random:!V" );

   //options from TMVAClassification.C
   // Gradient Boost
   factory->BookMethod( TMVA::Types::kBDT, "BDTGv2",
