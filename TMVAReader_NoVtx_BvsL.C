...
void TMVAReader(){
    ...
    reader->AddSpectator("TagVarCSV_jetNTracksEtaRel",&TagVarCSV_jetNTracksEtaRel);
    reader->AddSpectator("TagVarCSV_trackEtaRel_0",&TagVarCSV_trackEtaRel_0);
    reader->AddSpectator("TagVarCSV_trackEtaRel_1",&TagVarCSV_trackEtaRel_1);
    reader->AddSpectator("TagVarCSV_trackEtaRel_2",&TagVarCSV_trackEtaRel_2);
    reader->AddSpectator("TagVarCSV_jetNSecondaryVertices",&TagVarCSV_jetNSecondaryVertices);
    reader->AddSpectator("TagVarCSV_vertexMass",&TagVarCSV_vertexMass);
    reader->AddSpectator("TagVarCSV_vertexNTracks",&TagVarCSV_vertexNTracks);
    reader->AddSpectator("TagVarCSV_vertexEnergyRatio",&TagVarCSV_vertexEnergyRatio);
    ...
    reader->BookMVA( "BDTG_T1000D3_BvsL method", "weights/TMVATrainer_NoVtx_BDTG_T1000D3_BvsL.weights.xml" );
    ...
    for(Long64_t iEntry = 0; iEntry < intree->GetEntries(); iEntry++){
	    ...
	    float BDTG_Disc = reader->EvaluateMVA("BDTG_T1000D3_BvsL method");
    ...
    TString outname = "QCD_Pt-120to170_TuneZ2star_8TeV_pythia6_BDTG_vs_CSV_NoVtx_BvsL.root";
