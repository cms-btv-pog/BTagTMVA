...
void TMVATrainer(){
   ...
   TString outfileName = "TMVATrainingResults_PseudoVtx_BvsL.root";
   ...
   TMVA::Factory *factory = new TMVA::Factory( "TMVATrainer_PseudoVtx", outputFile,
   ...
   TCut signalCut = "abs(Jet_flavour)==5 && TagVarCSV_vertexCategory==1";
   TCut backgroundCut = "abs(Jet_flavour)!=5 && abs(Jet_flavour)!=4 && TagVarCSV_vertexCategory==1";
