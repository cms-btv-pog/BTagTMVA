...
void TMVAReader(){
    ...
    reader->BookMVA( "BDTG_T1000D3_BvsL method", "weights/TMVATrainer_RecoVtx_BDTG_T1000D3_BvsL.weights.xml" );
    ...
    TString outname = "QCD_Pt-120to170_TuneZ2star_8TeV_pythia6_BDTG_vs_CSV_RecoVtx_BvsL.root";
